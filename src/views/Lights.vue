    ...
    <section>
      <div class="lights">
        ...
        <div class="lightSwitchButton">
          ...
          <div>
            <button @click.prevent="viewLight" id="1" class="view">View</button>
          </div>
        </div>
        ...
        <div class="lightSwitchButton">
          ...
          <div>
            <button @click.prevent="viewLight" id="2" class="view">View</button>
          </div>

          <!-- <input v-model="viewLight" /> -->
  ...
  methods: {
    ...
    viewLight() {
      document.getElementById("1").onclick = function () {
        return this.currentEnergy2;
        // return (output = console.log(btn1Clicked));
      };
    },
  },
  computed: {
    ...
    // get() {
    //   return this.$store.state.currentEnergy2;
    // },
    // viewLight() {
    //   return this.$store.state.currentEnergy2;
    // },
